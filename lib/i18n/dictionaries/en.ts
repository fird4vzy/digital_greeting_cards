...
export const en: Dictionary = {
    ...
    create: {
      ...
      steps: {
        ...
        preview: {
          ...
          wishHint: 'You did not pick a template, so there is none to show. Here is what you asked for.',
          wishTitle: 'What you asked for',
          wishWork: 'Something like “{title}” — with your words and your photographs.',
          for: 'For',
          from: 'From',
          template: 'Template',
          photos: 'Photographs',
  ...
  admin: {
    ...
    order: {
      ...
      custom: {
        ...
        lead: 'If you wrote the card by hand, pick its whole folder. The QR then leads to that instead of a template composition. Limit: 4 MB per file, so heavy video will not go through.',
        pick: 'Choose a folder',
        replace: 'Upload more files',
        uploading: 'Uploading {done} of {total}…',
        entryLabel: 'Opens with',
        entryNone: 'Not chosen — the template is shown',
        empty: 'No files yet.',
        summary: 'Files: {count}, {size} in total',
        removeAll: 'Remove this card',
        removeConfirm: 'Delete every uploaded file? The order goes back to the template composition.',
        showing: 'The code currently opens the uploaded card.',
        showingEngine: 'The code currently opens the template composition.',
        unitMb: 'MB',
        unitKb: 'KB',
      },
      ...
      customLive: 'Your card is uploaded — the code opens it. There is nothing left to compose.',
      customNextPublish:
        'One step left: set the status to Published. Until then the address answers nobody, the tag QR included.',
      customPublished: 'Status is Published — the address works and the QR leads to it.',
  ...
  content: {
    ...
    card: {
      ...
      galleryEmpty: 'No photographs yet',
    ...
    looks: {
      'cover.arch': 'Arch',
      'cover.film': 'Video behind',
      'cover.glow': 'Glow',
      'cover.gradient': 'Gradient',
      'cover.paper': 'Paper',
      'cover.washi': 'Washi',
      'envelope.heart': 'Heart',
      'envelope.ribbon': 'Ribbon',
      'envelope.washi': 'Washi',
      'envelope.wax': 'Wax seal',
      'intro.centered': 'Centred',
      'intro.offset': 'Offset',
      'letter.handwritten': 'Handwritten',
      'letter.lines': 'Line by line',
      'letter.serif': 'Serif',
      'letter.washi': 'Washi',
      'video.framed': 'Framed',
      'video.full': 'Full width',
      'video.screen': 'Screen',
      'gallery.filmstrip': 'Filmstrip',
      'gallery.mosaic': 'Mosaic',
      'gallery.polaroid': 'Polaroid',
      'gallery.stack': 'Stack',
      'timeline.ledger': 'Ledger',
      'timeline.thread': 'Thread',
      'memories.chips': 'Chips',
      'memories.notes': 'Notes',
      'quote.centered': 'Centred',
      'quote.rule': 'With a rule',
      'wishes.list': 'List',
      'question.chase': 'Fleeing button',
      'question.plain': 'Plain',
