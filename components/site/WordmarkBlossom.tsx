...
/**
 * The previous mark, kept for the record.
 *
 * Nothing imports it. It was the identity until the product was named Bir
 * dunyo on 13 August, and `app/icon.svg` still borrows its five-petal blossom
 * — at 72° apart — for the face of the card in the tab.
 *
 ...
 * brand.
 */
export function WordmarkBlossom({
  className,
  tone = 'ink',
  href = '/',
}: {
