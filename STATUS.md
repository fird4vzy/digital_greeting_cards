...
4. **Нет постраничной выдачи в админке.** Предел 50 и никакого «дальше».
5. **Приватность.** Нет политики хранения, нет удаления по запросу, нет
   согласия получателя — а его имя и фотографии обрабатываются, и он о нас не
   просил. Работа не по коду, но она нужна.
6. **Один пароль на все магазины.** Пока магазин один — это честное
